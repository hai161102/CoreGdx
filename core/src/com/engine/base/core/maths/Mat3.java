...
public class Mat3 implements Serializable {
    ...
    public Mat3 mul (@NotNull Mat3 m) {
        float[] val = this.val;
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 mulLeft (@NotNull Mat3 m) {
        float[] val = this.val;
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 setToRotationRad (float radians) {
    ...
    public Mat3 setToRotation (Vec3 axis, float degrees) {
        return setToRotation(axis, MathUtils.cosDeg(degrees), MathUtils.sinDeg(degrees));
    }

    public Mat3 setToRotation (@NotNull Vec3 axis, float cos, float sin) {
        float[] val = this.val;
        float oc = 1.0f - cos;
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 setToTranslation (@NotNull Vec2 translation) {
        float[] val = this.val;
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 setToScaling (@NotNull Vec2 scale) {
        float[] val = this.val;
        val[M00] = scale.x;
        val[M10] = 0;
        val[M20] = 0;
    ...
    public Mat3 set (@NotNull Mat3 mat) {
     ...
     * @return This matrix for the purposes of chaining. */
    public Mat3 set (@NotNull Affine2 affine) {
        float[] val = this.val;
     ...
     * @return This matrix for the purpose of chaining operations. */
    public Mat3 set (@NotNull Mat4 mat) {
        float[] val = this.val;
    ...
    public Mat3 trn (@NotNull Vec2 vector) {
        val[M02] += vector.x;
        val[M12] += vector.y;
        return this;
    }
     ...
     * @return This matrix for the purpose of chaining. */
    public Mat3 trn (@NotNull Vec3 vector) {
        val[M02] += vector.x;
        val[M12] += vector.y;
        return this;
    }
     ...
     * @param translation The translation vector.
     * @return This matrix for the purpose of chaining. */
    public Mat3 translate (@NotNull Vec2 translation) {
        float[] val = this.val;
        tmp[M00] = 1;
        tmp[M10] = 0;
        tmp[M20] = 0;
     ...
     * @param degrees The angle in degrees
     * @return This matrix for the purpose of chaining. */
    public Mat3 rotate (float degrees) {
     ...
     * @param radians The angle in radians
     * @return This matrix for the purpose of chaining. */
    public Mat3 rotateRad (float radians) {
     ...
     * @return This matrix for the purpose of chaining. */
    public Mat3 scale (@NotNull Vec2 scale) {
        float[] tmp = this.tmp;
        tmp[M00] = scale.x;
        tmp[M10] = 0;
        tmp[M20] = 0;
    ...
    public Vec2 getTranslation (@NotNull Vec2 position) {
        position.x = val[M02];
        position.y = val[M12];
        return position;
    }
    ...
    public Vec2 getScale (@NotNull Vec2 scale) {
        float[] val = this.val;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat3 scl (@NotNull Vec2 scale) {
        val[M00] *= scale.x;
        val[M11] *= scale.y;
        return this;
    }
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat3 scl (@NotNull Vec3 scale) {
        val[M00] *= scale.x;
        val[M11] *= scale.y;
        return this;
    }
    ...
    private static void mul (float @NotNull [] mata, float @NotNull [] matb) {
    ...
    public Matrix3 convert() {
        return new Matrix3(
                this.getValues()
        );
    }
    public Mat3 fromMatrix3(Matrix3 from) {
        return new Mat3(from.getValues());
    }
}
