...
public class Mat4  implements Serializable {
    ...
    /** XW: Typically the translation of the X component. On Vec3 multiplication this value is added to the target X
     * component. */
    ...
    /** YW: Typically the translation of the Y component. On Vec3 multiplication this value is added to the target Y
     * component. */
    ...
    /** ZW: Typically the translation of the Z component. On Vec3 multiplication this value is added to the target Z
     * component. */
     ...
     * @param Quat The Quat to be copied. (The Quat is not modified) */
    public Mat4 (Quat Quat) {
        set(Quat);
    }
    ...
    public Mat4 (Vec3 position, Quat rotation, Vec3 scale) {
    ...
    public Mat4 set (@NotNull Mat4 matrix) {
    ...
    /** Sets the matrix to a rotation matrix representing the Quat.
     * @param Quat The Quat that is to be used to set this matrix.
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 set (@NotNull Quat Quat) {
        return set(Quat.x, Quat.y, Quat.z, Quat.w);
    }

    /** Sets the matrix to a rotation matrix representing the Quat.
     *
     * @param QuatX The X component of the Quat that is to be used to set this matrix.
     * @param QuatY The Y component of the Quat that is to be used to set this matrix.
     * @param QuatZ The Z component of the Quat that is to be used to set this matrix.
     * @param QuatW The W component of the Quat that is to be used to set this matrix.
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 set (float QuatX, float QuatY, float QuatZ, float QuatW) {
        return set(0f, 0f, 0f, QuatX, QuatY, QuatZ, QuatW);
    }
    ...
    public Mat4 set (@NotNull Vec3 position, @NotNull Quat orientation) {
        return set(position.x, position.y, position.z, orientation.x, orientation.y, orientation.z, orientation.w);
    }

    /** Sets the matrix to a rotation matrix representing the translation and Quat.
     ...
     * @param QuatW The W component of the Quat that is to be used to set this matrix.
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 set (float translationX, float translationY, float translationZ, float QuatX, float QuatY,
                        float QuatZ, float QuatW) {
        final float xs = QuatX * 2f, ys = QuatY * 2f, zs = QuatZ * 2f;
        final float wx = QuatW * xs, wy = QuatW * ys, wz = QuatW * zs;
        final float xx = QuatX * xs, xy = QuatX * ys, xz = QuatX * zs;
        final float yy = QuatY * ys, yz = QuatY * zs, zz = QuatZ * zs;
     ...
     * @param scale The scale
     * @return This matrix for chaining */
    public Mat4 set (@NotNull Vec3 position, @NotNull Quat orientation, @NotNull Vec3 scale) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 set (float translationX, float translationY, float translationZ, float QuatX, float QuatY,
                        float QuatZ, float QuatW, float scaleX, float scaleY, float scaleZ) {
        final float xs = QuatX * 2f, ys = QuatY * 2f, zs = QuatZ * 2f;
        final float wx = QuatW * xs, wy = QuatW * ys, wz = QuatW * zs;
        final float xx = QuatX * xs, xy = QuatX * ys, xz = QuatX * zs;
        final float yy = QuatY * ys, yz = QuatY * zs, zz = QuatZ * zs;
    ...
    public Mat4 set (@NotNull Vec3 xAxis, @NotNull Vec3 yAxis, @NotNull Vec3 zAxis, @NotNull Vec3 pos) {
        val[M00] = xAxis.x;
        val[M01] = xAxis.y;
        val[M02] = xAxis.z;
        val[M10] = yAxis.x;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 trn (@NotNull Vec3 vector) {
        val[M03] += vector.x;
        val[M13] += vector.y;
        val[M23] += vector.z;
        return this;
     ...
     * @param matrix The other matrix to multiply by.
     * @return This matrix for the purpose of chaining operations together. */
    public Mat4 mulLeft (Mat4 matrix) {
        tmpMat.set(matrix);
        mul(tmpMat.val, val);
        return set(tmpMat);
    }
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToProjection (float near, float far, float fovy, float aspectRatio) {
        idt();
     ...
     * @param far The far plane
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToProjection (float left, float right, float bottom, float top, float near, float far) {
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setTranslation (@NotNull Vec3 vector) {
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
        return this;
     ...
     * @param vector The translation vector
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToTranslation (@NotNull Vec3 vector) {
        idt();
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToTranslationAndScaling (@NotNull Vec3 translation, @NotNull Vec3 scaling) {
        idt();
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToRotation (Vec3 axis, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToRotationRad (Vec3 axis, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @param degrees The angle in degrees
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToRotation (float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @param radians The angle in radians
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 setToRotationRad (float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together */
    public Mat4 setToRotation (final Vec3 v1, final Vec3 v2) {
     ...
     * @return This matrix for the purpose of chaining methods together */
    public Mat4 setToRotation (final float x1, final float y1, final float z1, final float x2, final float y2, final float z2) {
     ...
     * @return This matrix */
    public Mat4 setFromEulerAnglesRad (float yaw, float pitch, float roll) {
     ...
     * @return This matrix for chaining. */
    public Mat4 setToScaling (@NotNull Vec3 vector) {
        idt();
        val[M00] = vector.x;
        val[M11] = vector.y;
        val[M22] = vector.z;
     ...
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 lerp (Mat4 matrix, float alpha) {
        for (int i = 0; i < 16; i++)
     ...
     * @return This matrix for chaining */
    public Mat4 avg (@NotNull Mat4 other, float w) {
        getScale(tmpVec);
     ...
     * @return This matrix for chaining */
    public Mat4 avg (Mat4 @NotNull [] t) {
     ...
     * @return This matrix for chaining */
    public Mat4 avg (Mat4 @NotNull [] t, float @NotNull [] w) {
    ...
    public Mat4 set (@NotNull Mat3 mat) {
        val[0] = mat.val[0];
        val[1] = mat.val[1];
        val[2] = mat.val[2];
        val[3] = 0;
     ...
     * @return This matrix for chaining */
    public Mat4 set (@NotNull Affine2 affine) {
        val[M00] = affine.m00;
        val[M10] = affine.m10;
        val[M20] = 0;
        val[M30] = 0;
     ...
     * @return This matrix for chaining */
    public Mat4 setAsAffine (@NotNull Affine2 affine) {
        val[M00] = affine.m00;
        val[M10] = affine.m10;
        val[M01] = affine.m01;
        val[M11] = affine.m11;
     ...
     * @return This matrix for chaining */
    public Mat4 setAsAffine (@NotNull Mat4 mat) {
        val[M00] = mat.val[M00];
        val[M10] = mat.val[M10];
        val[M01] = mat.val[M01];
        val[M11] = mat.val[M11];
    ...
    public Mat4 scl (@NotNull Vec3 scale) {
        val[M00] *= scale.x;
        val[M11] *= scale.y;
        val[M22] *= scale.z;
        return this;
    ...
    public Vec3 getTranslation (@NotNull Vec3 position) {
        position.x = val[M03];
        position.y = val[M13];
        position.z = val[M23];
        return position;
    ...
    public Quat getRotation (@NotNull Quat rotation, boolean normalizeAxes) {
     ...
     * @param rotation The {@link Quat} to receive the rotation
     * @return The provided {@link Quat} for chaining. */
    public Quat getRotation (@NotNull Quat rotation) {
	...
	static inline void Mat4_mul(float* mata, float* matb) {
		float tmp[16];
	...
	static inline void Mat4_mulVec(float* mat, float* vec) {
	...
	static inline void Mat4_proj(float* mat, float* vec) {
	...
	static inline void Mat4_rot(float* mat, float* vec) {
	...
	*/
     ...
     * subsequent vectors and must be >= 3. This is the same as  applied to multiple vectors.
     * @param mat the matrix
     * @param vecs the vectors
     * @param offset the offset into the vectors array
     * @param numVecs the number of vectors
	...
	*/
     ...
     * column major matrix as you can get from {@link Mat4#val}. The vector array is assumed to hold a 3-component vector, with
     ...
     * is the same as {@link Vec3#rot(Mat4)}.
     * @param mat the matrix
     * @param vec the vector. */
     ...
     * @param radians The angle in radians.
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 rotateRad (Vec3 axis, float radians) {
     ...
     * @param degrees The angle in degrees
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 rotate (float axisX, float axisY, float axisZ, float degrees) {
        if (degrees == 0) return this;
     ...
     * @param radians The angle in radians
     * @return This matrix for the purpose of chaining methods together. */
    public Mat4 rotateRad (float axisX, float axisY, float axisZ, float radians) {
        if (radians == 0) return this;
     ...
     * @param v2 The target vector
     * @return This matrix for the purpose of chaining methods together */
    public Mat4 rotate (final Vec3 v1, final Vec3 v2) {
     ...
     * @param up up vector
     * @return This matrix for chaining */
    public Mat4 rotateTowardDirection (final Vec3 direction, final Vec3 up) {
        l_vez.set(direction).nor();
        l_vex.set(direction).crs(up).nor();
        l_vey.set(l_vex).crs(l_vez).nor();
     ...
     * @param up the up vector
     * @return This matrix for chaining */
    public Mat4 rotateTowardTarget (final Vec3 target, final Vec3 up) {
    ...
    public Matrix4 convert() {
        return new Matrix4(this.getValues());
    }
    public Mat4 fromMatrix4(Matrix4 from) {
        return new Mat4(from.getValues());
    }
}
